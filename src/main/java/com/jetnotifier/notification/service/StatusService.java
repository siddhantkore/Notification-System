...
public class StatusService {
    ...
    public Map<String, Object> getUserNotificationStats(String userId) {
        ...
        long pendingNotifications = notificationRepository.countByUserIdAndStatus(userId, NotificationStatus.PENDING);
    ...
    public Map<String, Object> getSystemStatus() {
        ...
        systemStatus.put("successRate", totalNotifications > 0 ? (double) sentNotifications/totalNotifications*100 : 0);
